...
export const Home = () => (
  <div className="Container">
    <div className="HomeMainContent">
      ...
      <p>
        As a seasoned Full-Stack Developer, I bring extensive expertise and a
        strong commitment to delivering high-quality solutions. My comprehensive
        knowledge of the software development lifecycle, coupled with a
        versatile skill set, allows me to address complex challenges
        effectively. <br />
        ...
        highlights my value as a team member, ready to take on diverse projects
